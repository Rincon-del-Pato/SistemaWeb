...
class InventoryItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('inventory_items')->insert([
            ['supplier_id' => 1, 'name' => 'Harina', 'item_type' => 'Ingrediente', 'quantity' => 100, 'reorder_level' => 10, 'unit_id' => 1, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['supplier_id' => 1, 'name' => 'Azúcar', 'item_type' => 'Ingrediente', 'quantity' => 50, 'reorder_level' => 5, 'unit_id' => 1, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
