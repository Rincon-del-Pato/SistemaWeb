...
<div class="w-full">
    <div class="mb-8">
        <label for="unit_name" class="block mb-2 text-lg font-medium text-gray-900">
            Nombre de la Unidad
        </label>
    ...
    <div class="mb-8">
        <label for="abbreviation" class="block mb-2 text-lg font-medium text-gray-900">
            Abreviación
        </label>
    ...
    <div class="mb-8">
        ...
        <textarea name="description" id="description" rows="4"
            class="block w-full p-3 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500">{{ $unit->description ?? old('description') }}</textarea>
    </div>
